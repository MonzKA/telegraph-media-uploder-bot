...
Bot = Client(
    ...
    bot_token=os.environ.get("5710006787:AAH4XE2dKG_A3ekHr-4bOBVjFBepZvKudQ8"),
    api_id=int(os.environ.get("14401954")),
    api_hash=os.environ.get("c342aca287037f205a0dcbe8c7d82579")
)
